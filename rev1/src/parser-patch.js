...
function applyParserPatch(originalParser) {
...
function testPatch() {
  ...
  // Output the patched parser to a temporary file for testing
  ...
  const { parseNotedown } = require(patchedParserPath);
