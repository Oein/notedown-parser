...
describe("Nested Collapse Rendering", () => {
    ...
    test("should render nested collapse as a new Notedown document inside parent collapse", () => {
        ...
        const detailsElements = htmlContainer.querySelectorAll("details.notedown-collapse");
        ...
        expect(inner?.querySelector("summary")?.textContent).toContain("Inner Collapse");
        expect(outer.querySelector("summary")?.textContent).toContain("Outer Collapse");
    });
});
//# sourceMappingURL=collapse-nested-renderer.test.js.map